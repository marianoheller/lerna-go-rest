...
func NewUserPayloadResponse(user *d.User) *UserPayload {
	return &UserPayload{User: user}
}

type ArticleRequest struct {
	*d.CreateArticleRequest
...
func (a *ArticleRequest) Bind(r *http.Request) error {
	...
	if a.CreateArticleRequest == nil {
		return errors.New("missing required CreateArticleRequest fields.")
	}
	...
	a.CreateArticleRequest.Title = strings.ToLower(a.CreateArticleRequest.Title) // as an example, we down-case
	return nil
}
